...
export default function GetRestaurantPage() {
  ...
  return (
    <div className="w-full mx-auto h-full shadow-lg rounded-lg overflow-hidden dark:text-white">
        <h1 className='text-2xl my-5 text-center'>Perfil del restaurante</h1>
        <div className="dark:bg-gray-600 bg-gray-300 h-40"></div>
        ...
        <div className="py-4 px-6 text-center">
            ...
            <p className=' text-xl font-semibold mt-2'>Detalles <span className='text-sm font-normal'>(Solo tu puedes ver esto)</span></p>
            <p className=' mt-1'><span className='font-semibold'>Propietario:</span> {user.paternal_surname}  {user.maternal_surname} {user.name}</p>
            {/* <p className=''><span className='font-semibold'>Total de empleados:</span> 10</p> */}
            {/* <p className=''><span className='font-semibold'>Total de menus:</span> 2</p> */}
            <p className=''><span className='font-semibold'>Menú publicado:</span> Si</p>
        </div>
  </div>
  );
}
