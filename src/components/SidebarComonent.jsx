...
export default function SidebarComonent() {
  ...
  return (      
    <aside id="sidebar-multi-level-sidebar" className={`mt-0 fixed top-0 left-0 z-8 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0`} aria-label="Sidebar">
