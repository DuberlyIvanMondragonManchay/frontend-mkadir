...
export default function SidebarComonent() {
  ...
  return (      
    <aside id="sidebar-multi-level-sidebar" className={`mt-24 bg-white fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0`} aria-label="Sidebar">
