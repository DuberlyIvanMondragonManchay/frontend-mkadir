...
import CardDoc from '../cards/CardDoc'
...
export default function MenuDoc(props) {
  return (
    ...
    <CardDoc cardTitle="Registrar Menú" cardIcon="01" cardText="Podras registrar para luego publicar tu menú para que las demás personas accedan online."/>
    <CardDoc cardTitle="Toma una foto" cardIcon="02" cardText="Toma unam foto a tu menu y subela parea atrer mas clientes."/>
